...
""));
        ...
        TicTacToeText->setEnabled(true);
        TicTacToeText->setGeometry(QRect(160, 30, 461, 81));
        QFont font1;
        font1.setPointSize(50);
        TicTacToeText->setFont(font1);
        TicTacToeText->setAcceptDrops(true);
        TicTacToeText->setAutoFillBackground(true);
        TicTacToeText->setFrame(false);
        TicTacToeText->setEchoMode(QLineEdit::Normal);
        TicTacToeText->setAlignment(Qt::AlignCenter);
        TicTacToeText->setDragEnabled(false);
